			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="http://localhost:8080/Artisan/type">Theme</a></li>
		...
		<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								<h3>VACANCE</h3>
								<a href="http://localhost:8080/Artisan/type?type_c=vacance" class="cta-btn">Catalogue <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								<h3>AVENTURE</h3>
								<a href="http://localhost:8080/Artisan/type?type_c=aventure" class="cta-btn">Catalogue <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								<h3>TRAVAILLE</h3>
								<a href="http://localhost:8080/Artisan/type?type_c=travaille" class="cta-btn">Catalogue <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								<h3>${ voyage.theme }</h3>
								<a href="http://localhost:8080/Artisan/type?type_c=${ voyage.theme }" class="cta-btn">Catalogue <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					</c:forEach>
